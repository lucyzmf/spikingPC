...
class OneLayerSeqModelPop(nn.Module):
    def __init__(self, n_inp, n_hid, n_out, n_readout, use_spikes, is_rec=True, is_LTC=True, is_adapt=True,
                 one_to_one=False):
        ...
        self.network = OneLayerSnnUpdated(input_size=n_inp, hidden_size=n_hid, output_size=n_out,
